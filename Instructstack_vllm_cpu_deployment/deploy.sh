...
# =============================================================================
# VLLM CPU Deployment Script
# =============================================================================
# This script automates the complete deployment of the VLLM CPU-based inference
...
setup_environment() {
    ...
    if grep -q "LOGFIRE_TOKEN=your_logfire_token_here" .env; then
...
download_models() {
    ...
    if [ ! -d "models/facebook/opt-125m" ] && [ ! -d "models/sshleifer/tiny-gpt2" ]; then
...
start_services() {
    print_status "Starting VLLM CPU stack..."
...
show_urls() {
    echo ""
    print_success "🎉 VLLM CPU Stack is now running!"
    echo ""
    echo "📊 Service URLs:"
    ...
    echo ""
    echo "🧪 Test the API:"
    echo "  • Run test script: python3 test_vllm.py"
    echo ""
}
...
main() {
    echo ""
    echo "🚀 VLLM CPU Stack Deployment Script"
    echo "=================================="
    echo ""
